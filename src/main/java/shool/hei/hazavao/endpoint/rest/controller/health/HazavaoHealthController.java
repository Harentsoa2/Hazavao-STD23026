...
public class HazavaoHealthController {
    ...
    @GetMapping("/hazavao")
    public String hazavao(@RequestParam String prompt) {
        TextCompletionModel model = TextCompletionModel.GPT_3_5_TURBO;
        List<ChatGptRequest.Message> messages = List.of(new ChatGptRequest.Message(MessageRole.USER, "donner la definition en Malagasy de"+ prompt));
